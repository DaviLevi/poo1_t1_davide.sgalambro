...
public class Lista {
    ...
    public void adicionaPosicao(int posicao, int valor){
        if(tamanho() == 0 || posicao < 0 || posicao >= tamanho()) throw new ArrayIndexOutOfBoundsException("Indice invalido");
    ...
    public int buscaValorNaPosicao(int posicao){
        ...
        if( posicao < 0 || 
            posicao >= this.tamanho) throw new ArrayIndexOutOfBoundsException("Indice invalido");
